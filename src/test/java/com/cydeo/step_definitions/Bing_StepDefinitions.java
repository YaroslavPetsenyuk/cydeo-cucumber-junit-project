...
public class Bing_StepDefinitions {
    ...
    public void userEntersInTheBingSearchBox(String searchKey) throws InterruptedException {
        Thread.sleep(3000);
    ...
    public void user_enters_orange_in_the_bing_search_box() throws InterruptedException {
        Thread.sleep(3000);
